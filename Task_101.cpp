...
return 0;
 ...
 win = SDL_CreateWindow("Drawing A Circle",SDL_WINDOWPOS_CENTERED,SDL_WINDOWPOS_CENTERED,SCREEN_WIDTH,SCREEN_HEIGHT, 0);
if (!win)
    {
...
while(gameIsRunning)
{
	...
	SDL_SetRenderDrawColor(rend, 250, 0, 150, 0);
